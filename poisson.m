...
%
% when testing poisson, sometimes we don't want to feed in the entire wap500 field
% but normally this line of code is needed: 
...
a_earth=6350000;
rad = pi/180.;
%r=23.5; % relaxation parameter, if r=1, SOR reduces to Gauss-Seidel method
%conv=864.; % (hPa s)/(Pa day); used to convert Pa/s to hPa/day

% conv is set in the omega_plot.m script
wap500_temp=conv.*wap500;
